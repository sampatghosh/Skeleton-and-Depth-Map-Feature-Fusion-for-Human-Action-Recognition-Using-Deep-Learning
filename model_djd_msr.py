# -*- coding: utf-8 -*-
"""model_sampat_MSR.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/11ByXqA9obrGrOwV34zDy3xImn6LT5DNg
"""
...
def get_data(DATADIR,shuff):
  ...
  def action_label_img(img):
    # print("ert",img)
    img = img[:-4]
    action_label = img.split('_')
    # print(action_label)
    if action_label[0][1] == '0':
      i = int(action_label[0][2:]) - 1
      label = [0] * 20
      label[i] = 1
      return label
    else:
      i = int(action_label[0][1:]) - 1
      label = [0] * 20
      label[i] = 1
      return label
...
X_train,y_train = get_data('/content/drive/MyDrive/M.Tech NITK/Minor Project/MinorProject/DJD_MSR/subject_odd',True)

print(X_train.shape,y_train.shape)

X_test,y_test = get_data('/content/drive/MyDrive/M.Tech NITK/Minor Project/MinorProject/DJD_MSR/subject_even',False)
...
history = model.fit(X_train, y_train, epochs=1000, batch_size=64, validation_data=(X_test, y_test), verbose=1,callbacks=[checkpoint])
